    ...
    switch (what) {
      case "ie": {
        this.modals.push({
          ...
          template: html`
            <modal-ie
              title="Stefano Tagliabue CV"
              @close="${this._handleModalClose.bind(this, "ie")}"
              noBodyMargin="true"
            >
    ...
    return html`
      <div>
        <general-item
          ...
          imgSrc="assets/ico/desktop/internet-explorer.png"
        ></general-item>

        <general-item
          @doubleClick="${this._handleGithubDoubleClick}"
          text="Source Code"
          imgSrc="assets/ico/desktop/github.png"
        ></general-item>
